export default {
	...
	donate: 'Doar',
	donation_banner: 'HiberFile é gratuito e precisa de doações para funcionar. Se quiser ajudar, {click_here} (obrigado).',
	...
	toast_max_size: 'O(s) ficheiro(s) é(são) demasiado grande(s). O tamanho não deve exceder os 50 GB.',
